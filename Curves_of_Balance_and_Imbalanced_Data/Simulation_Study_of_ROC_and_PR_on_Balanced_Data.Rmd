...
# classifier E:
predicted_value_E = c(rbeta(3000, 12, 2), rbeta(7000, 3, 4), rbeta(negative_num, 2, 3))
# classifier F:
predicted_value_F = c(rbeta(positive_num, 4, 3), rbeta(negative_num, 2, 3))
# perfect classifier
...
# ROC 
classification_plot(real, prediction, c(fpr_index, recall_index), model_name, "ROC", "FPR", "Recall","10000:10000")
# PR
classification_plot(real, prediction, c(recall_index, precision_index), model_name,  "PR", "Recall", "Precision","10000:10000")
# mcc-f1
classification_plot(real, prediction, c(f_score_index, mcc.nor_index, mcc_measure_index), model_name,  "mcc-f1", "F1", "MCC", "10000:10000")
# mcc-precision
classification_plot(real, prediction, c(precision_index, mcc.nor_index), model_name, "mcc-precision", "Precision", "MCC", "10000:10000")
# mcc-recall
classification_plot(real, prediction, c(recall_index, mcc.nor_index), model_name, "mcc-recall", "Recall", "MCC", "10000:10000")
```
