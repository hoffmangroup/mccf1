...
predicted_value_A = c(rbeta(300, 12, 2), rbeta(700, 3, 3.5),rbeta(10000, 2, 3))
# classifier B:
predicted_value_B = c(rbeta(600, 5, 3), rbeta(400, 4, 3), rbeta(10000, 2, 3))
...
predicted_value_C = c(rbeta(3000, 9, 2), rbeta(7000, 2, 4), rbeta(1000, 2, 4))
predicted_value_D = c(rbeta(6000, 4, 3), rbeta(4000, 3, 4), rbeta(1000, 2, 4))
