...
# ROC 
classification_plot(real, prediction, c(fpr_index, tpr_index, auc_index), model_name, "ROC", "FPR", "TPR","1000:10000")
# PR
...
# ROC 
classification_plot(real, prediction, c(fpr_index, tpr_index, auc_index), model_name, "ROC", "FRR", "TPR", "10000:1000")
# PR
...
```{r,echo=F, eval=T,cache=T, message=F,warning=F}
real = real_value
predicted_value_4 = c(rbeta(350, 15, 0.5), rbeta(650, 2.25, 4), rbeta(10000, 2, 4))
predicted_value_5 = c(rbeta(400, 3.3, 3), rbeta(600, 3, 4), rbeta(10000, 2, 4))
predicted_value_6 = c(rbeta(400, 3.3, 3), rbeta(600, 3, 4), rbeta(4550, 1, 10), rbeta(5450, 4, 4.5))
prediction = cbind(predicted_value_4, predicted_value_5, predicted_value_6)
model_name= c("type 4", "type 5", "type 6")

# ROC 
classification_plot(real, prediction, c(fpr_index, tpr_index, auc_index), model_name, "ROC", "FRR", "TPR", "1000:10000")
# PR
classification_plot(real, prediction, c(recall_index, precision_index), model_name, "PR", "Recall", "Precision", "1000:10000" )
# mcc-f1
classification_plot(real, prediction, c(f_score_index, mcc.nor_index, mcc_measure_index), model_name, "mcc-f1", "F1", "MCC",  "1000:10000")
