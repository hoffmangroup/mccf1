---
title: "Comparison between ROC, PR and MCC-F1 curves with unbalanced Diabetes data(9:1)"
---
...
fdata1 <- fdata_1[sample(nrow(fdata_1), 180),]
fdata0 <- fdata_0[sample(nrow(fdata_0), 20),]

train <- rbind(fdata1[1:90,], fdata0[1:10,])
test <- rbind(fdata1[91:180,], fdata0[11:20,])
